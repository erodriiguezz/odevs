    ...
    return  <div
             ...
             >
                ...
                >
                    ...
                    <nav
                    className="hidden md:flex items-center gap-1 bg-zinc-900 p-0.5 rounded-lg border border-zinc-800"
                    >
