...
export const icons = (<T extends Record<string, (state: any) => ReactElement >>(icon: T) => icon)({
  "magnifying-glass": () => <>
  ...
  "up-arrow": () => <path d="m18 15-6-6-6 6"/>,
  "down-arrow": () => <path d="m6 9 6 6 6-6"/>,
  "vertical-arrow": (up: boolean) => <path d={`M 6 ${up ? 15 : 9} L 12 ${up ? 9 : 15} L 18 ${up ? 15 : 9}`} className="transition-d duration-300"/>,
} as const);
