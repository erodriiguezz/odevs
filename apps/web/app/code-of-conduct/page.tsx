                    ...
                    <div className="max-w-none">
                        ...
                        <div className="text-medium-foreground bg-surface rounded-lg p-8 mb-8 theme-trans">
                            ...
                            <ul className="space-y-4 font-sans">
                                ...
                                <li>
                                    <strong>Be considerate:</strong> Your actions (and words) affect users and colleagues, and you should take those consequences into account. Remember that we're a very diverse community, so you might not be communicating in someone else's primary language.
                                </li>
                                <li>
                                    <strong>Be respectful:</strong> Not all of us will agree all the time, but disagreement is no excuse for poor behavior and poor manners. We might all experience some frustration now and then, but we cannot allow that frustration to turn into a personal attack. It's important to remember that a community where people feel uncomfortable or threatened is not a productive one.
                                </li>
                                <li>
                                    <strong>Be careful in the words that we choose:</strong> we are a community of professionals, and we conduct ourselves professionally. Be kind to others. Do not insult or put down other participants. Harassment and other exclusionary behavior aren't acceptable.
                                </li>
                                <li>
                                    <strong>Try to understand why we disagree:</strong> Disagreements, both social and technical, happen all the time. It is important that we resolve disagreements and differing views constructively. Remember that we're different. The strength of our community comes from its diversity, people from a wide range of backgrounds. Different people have different perspectives on issues. Being unable to understand why someone holds a viewpoint doesn't mean that they're wrong. Don't forget that it is human to err and blaming each other doesn't get us anywhere. Instead, focus on helping to resolve issues and learning from mistakes.
                                </li>
                            </ul>
                        </div>
                        <div className="bg-surface rounded-lg p-8 mb-8 text-medium-foreground theme-trans">
                            ...
                            <ul className="space-y-2 font-sans list-disc list-inside theme-trans">
                                ...
                                <li>Deliberate intimidation</li><li>Stalking or following</li>
                                <li>Harassing photography or recording, including logging online activity for harassment purposes</li>
                                <li>Sustained disruption of discussion</li><li>Unwelcome sexual attention, including gratuitous or off-topic sexual images or behaviour</li>
                                ...
                                <li>Deliberate "outing" of any aspect of a person's identity without their consent except as necessary to protect others from intentional abuse</li>
