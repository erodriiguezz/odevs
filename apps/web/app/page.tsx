...
export default function HomePage() {
  ...
  const groups = [
    ...
    { name: "Orlando Tech and Beer", icon: "images/group-icons/people.svg", category: group_categories["Community"],
      desc: "Connect. Collaborate. Inspire.", href: "https://lu.ma/otab"}
  ] as const;
